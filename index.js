...
const selfDividingNumbers = function (left, right) {
  ...
  for (let i = left; i <= right; i++) {
    ...
    let loopingValue = "";
    loopingValue = i.toString();

    for (let j = 0; j < loopingValue.length; j++) {
      const digit = Number(loopingValue[j]);
...
const result48 = selfDividingNumbers(1, 22);
